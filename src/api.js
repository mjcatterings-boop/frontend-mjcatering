...
const locations = [
  {
    ...
    occasions: ["wedding", "walima", "mehndi", "other"],
  ...
  },
  {
    ...
    name: "Farmhouses",
    type: "farmhouse",
    occasions: ["wedding", "walima", "nikkah", "other"],
  ...
  },
  {
    ...
    name: "Open area",
    type: "Open Area",
    occasions: ["mehndi", "birthday", "corporate", "other"],
    city: "Located Mostly In Rawalpindi and Islamabad",
    capacity: "According to your guests",
  },
  {
    ...
    name: "Rooftop",
    type: "Rooftop",
    occasions: ["nikkah", "birthday", "corporate", "other"],
    city: "Located Mostly In Rawalpindi and Islamabad",
    capacity: "According to your guests",
  },
  {
